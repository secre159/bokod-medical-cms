    ...
    <body class="landing-form flex items-center justify-center">
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Remember Me -->
                <div class="form-group">
                    <label for="remember_me" style="display: flex; align-items: center; font-weight: 400;">
                        <input 
                            id="remember_me" 
                            type="checkbox" 
                            name="remember"
                            style="margin-right: 0.5rem; accent-color: #22c55e;"
                        >
                        <span style="font-size: 0.875rem; color: #706f6c;">Remember me</span>
                    </label>
                </div>
